...
for k = 1:N
    ...
    % Velocidad angular
    w(k) = (4*(cos(tk^2)-2*(tk^2)*sin(tk^2))) / (1 + (4*tk*cos(tk^2))^2);
...
axis([0 5 -2.5 2.5 -1 1]); % Ingresar limites minimos y maximos en los ejes x y z [minX maxX minY maxY minZ maxZ]
