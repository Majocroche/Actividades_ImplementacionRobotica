...
tf = 8.9;             % Tiempo de simulacion en segundos (s)
...
u = [2*ones(1,10)     0*ones(1,10)     1.5*ones(1,10)   0*ones(1,10)     2*ones(1,10)     0*ones(1,10)     2*ones(1,10)  0*ones(1,10)      2.5*ones(1,10)]; % Velocidad lineal de referencia (m/s)
w = [0*ones(1,10)    -pi/2*ones(1,10)   0*ones(1,10)    -pi/2*ones(1,10)   0*ones(1,10)  pi/2*ones(1,10)  0*ones(1,10)  pi/2*ones(1,10)  0*ones(1,10)]; % Velocidad angular de referencia (rad/s)
...
for k=1:N 
    ...
    %phi(k) es el phi anterior
    
    %%%%%%%%%%%%%%%%%%%%% MODELO CINEMATICO %%%%%%%%%%%%%%%%%%%%%%%%%
    %Aplicamos el modelo cinemático diferencial para obtener las
    %velocidades en x, y, phi
    xp1=u(k)*cos(phi(k+1)); %velocidad lineal en x 
    yp1=u(k)*sin(phi(k+1)); %velocidad lineal en y
    phip= w(k) %velcodad angular
    ...
    hx(k+1)=x1(k+1); %posición en x
    hy(k+1)=y1(k+1); %posición en y
