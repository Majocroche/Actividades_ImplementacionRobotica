...
u = [0*ones(1,10)     1*ones(1,10)       0*ones(1,10)  1*ones(1,10)     0*ones(1,10) 1.5*ones(1,10)    0*ones(1,10) 2.2*ones(1,11)]; % Velocidad lineal de referencia (m/s)
w = [pi/6*ones(1,10)  0*ones(1,10)  2*pi/3*ones(1,10)  0*ones(1,10) -13*pi/18*ones(1,10) 0*ones(1,10)  -pi/2*ones(1,10)   0*ones(1,11)]; % Velocidad angular de referencia (rad/s)
